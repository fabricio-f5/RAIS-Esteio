...
INSERT INTO `db_webapp`.`configparameter`
(`parameter`,`description`,`parameterValue`) VALUES ('SupervisorEmailClaviculario','E-mail destino para mensagens de aviso caso o usuário pegue uma chave que não seja do seu perfil de acesso.','adenirtoniolofilho@gmail.com');
